...
import { Mic, LayoutGrid, FileText } from "lucide-react";
              ...
              {step === "studio" && (
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.9 }}
                    className="flex items-center gap-1.5 px-2.5 h-7 rounded bg-[#232328] border border-[#2A2A2E] hover:bg-[#2C2C33] hover:border-[#F97316]/40 transition-all"
                  >
                    <FileText
                      className="w-3 h-3 text-[#F97316]"
                      style={{ filter: "drop-shadow(0 0 4px #F9731660)" }}
                    />
                    <span className="text-[9px] uppercase tracking-wider font-semibold text-[#F97316]">
                      Lyrics
                    </span>
                  </motion.button>
